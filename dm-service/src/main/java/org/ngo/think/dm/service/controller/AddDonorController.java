...
import static org.ngo.think.dm.common.constant.CommonConstants.ServiceRequestMapping.ADD_DONOR;
...
public class AddDonorController
{
	...
	@RequestMapping(value = ADD_DONOR, method = RequestMethod.POST, consumes = APPLICATION_JSON, produces = APPLICATION_JSON)
	@ResponseBody
